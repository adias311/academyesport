<aside class="navbar navbar-vertical navbar-expand-lg navbar-dark">
    <div class="container">
        ...
        @role('admin')
         <a href="" class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal d-flex justify-content-center align-items-center">
            @else
         <a href="/" class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal d-flex justify-content-center align-items-center">
        @endrole           
            <img src="/logow.svg" alt="Logo" style="height: 38px;">
            <p class="font-weight-bold text-azure mb-0">Academy<span class="text-red">Esport</span></p>
        </a>   
        ...
        <div class="collapse navbar-collapse" id="navbar-menu">
            <ul class="navbar-nav pt-lg-3">
                @role('admin|instructor')
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ Route::is('member.cart*') ? 'active' : '' }}"
                ...
                @else
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ Route::is('member.transactions*') ? 'active' : '' }}"
                            ...
                            <span class="nav-link-icon d-md-none d-lg-inline-block mr-1">
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-cash"
                                    width="24" height="24" viewBox="0 0 22 22" stroke-width="2"
                                    stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                    <rect x="7" y="9" width="14" height="10" rx="2">
                                    </rect>
