...
<main>
    <div>
        <span>mlbb</span>
        <h1>Academy Esport</h1>
        <hr>
        <h3>Unlock the Depths of Esports Mastery. Dive in, Train Hard, and Conquer the Arena!</h3>
    ...
    <img src="https://e7.pngegg.com/pngimages/605/714/png-clipart-chinese-dragon-longjian-stroke-learning-chinese-mythology-chinese-dragon-material-white-painted.png" alt="" class="bg">
    <img src="https://e7.pngegg.com/pngimages/748/813/png-clipart-sketch-vertebrate-cartoon-line-art-hades-greek-mythology-legendary-creature-comics.png" alt="" class="bg2">
  </main>
    ...
    <style>
        ...
        * {
        ...
        background: linear-gradient(to top, #0f2027, #203a4300, #2c536400),
            url("/storage/image/slide1.jpg")
            no-repeat 50% 50% / cover;
        }

        .swiper-slide--two {
        background: linear-gradient(to top, #0f2027, #203a4300, #2c536400),
            url("/storage/image/slide2.jpg")
            no-repeat 50% 50% / cover;
        }

        .swiper-slide--three {
        background: linear-gradient(to top, #0f2027, #203a4300, #2c536400),
            url("/storage/image/slide3.jpg")
            no-repeat 50% 50% / cover;
        }

        .swiper-slide--four {
        background: linear-gradient(to top, #0f2027, #203a4300, #2c536400),
            url("/storage/image/slide4.jpg")
            no-repeat 50% 50% / cover;
        }

        .swiper-slide--five {
        background: linear-gradient(to top, #0f2027, #203a4300, #2c536400),
            url("/storage/image/slide5.jpg")
            no-repeat 50% 50% / cover;
        }
