...
@section('content')
    <div class="container-xl">
        <div class="row">
            ...
            <div class="col-md-6 col-lg-3">
                <x-utilities.widget title="Articles" subTitle="comming soon" class="bg-danger">
            ...
            <div class="col-12">
                <div class="alert alert-{{ $transactionVerified < 1 ? 'warning' : 'danger' }}" role="alert">
                    ...
                    You have <span class="text-{{ $transactionVerified < 1 ? 'primary' : 'danger' }}">{{ $transactionVerified }}</span> payment transactions that must
