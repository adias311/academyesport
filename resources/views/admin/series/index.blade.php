                                ...
                                <tr>
                                    ...
                                    <td>
                                        <x-button.button-dropdown title="Actions" class="btn btn-primary" icon="list">
                                            ...
                                            <x-button.button-link class="dropdown-item" title="content list"
                                                url="{{ route('admin.series.show', $data->slug) }}"
                                                icon="play-circle" />
                                            <x-button.button-link class="dropdown-item" title="Add Video"
                                                url="{{ route('admin.videos.create', $data->slug) }}"
                                                icon="plus" />
                                            <x-button.button-link class="dropdown-item" title="Add Document"
                                                url="{{ route('admin.documents.create', $data->slug) }}"
                                                icon="plus" />
