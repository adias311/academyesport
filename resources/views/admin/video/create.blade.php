                ...
                <x-card.card title="{{ $series->name }}">
                    <form action="{{ route('admin.videos.store', $series->slug) }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            {{-- <div class="col-6">
                                <x-form.input type="number" title="Video Duration" name="duration" value=""
                                    placeholder="input video duration" />
                            </div> --}}
                        </div>
                        <x-form.checkbox title="Intro">
                            <label class="form-check form-check-inline">
                                <input class="form-check-input @error('intro') is-invalid @enderror" type="checkbox"
                                    name="intro" value="1">
                                <span class="form-check-label">Make this an introductory video</span>
                            </label>
                        </x-form.checkbox>
