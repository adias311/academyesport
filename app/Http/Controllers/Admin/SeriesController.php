...
class SeriesController extends Controller
{
    ...
    {
        // call method uploadImage from trait hasCover
        ...
        //if series 3 return back 
        if(Series::count() >= 3){
            return redirect()->route('admin.series.index')->with('toast_error', 'You can only create 3 series');
        }        
