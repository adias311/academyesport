...
trait HasSeries
{
    ...
    public function bestSeries()
    {
        ...
        ->where('transaction_details.grand_total', '>', 0)
        ->addSelect(DB::raw('series.name as name, series.price as price, count(transaction_details.series_id) as total'))
        ->groupBy('transaction_details.series_id', 'series.name', 'series.price')
        ->paginate(7);
